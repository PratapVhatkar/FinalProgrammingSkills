...
//        if (!mGoogleApiClient.isConnecting()            // We only process button clicks when GoogleApiClient is not transitioning
//            // between connected and not connected.
//ed.
//            switch (v.getId()) {
//                case R.id.sign_in_butt//        mStatus.setText(R.string.status_signing_in);
//n);
//                    mSignInProgress = STATE_SIGN_IN;
//                    mGoogleApiClient.connect();
//                    bre//        case R.id.sign_out_button:
...
//    }
//    @Override
//    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked//        switch (buttonView.getId()) {
...
//        System.out.print("Facebook login cancelled");
//    }
//    @Override
//    public void onError(FacebookException e) {
//        System.out.print("Facebook login error" + e.toString());
//    }
//    @Override
